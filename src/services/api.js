...
import { getMenuDuration } from '../shared/menuConfig';
export { getMenuDuration };
// API configuration
 ...
 */
export async function getAvailability(from, to, durationMin) {
 ...
 */
export function toJSTISOString(date) {
